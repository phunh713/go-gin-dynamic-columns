...
func (h *${DOMAIN_NAME_LOWER}Handler) GetById(c *gin.Context) {
	...
	c.JSON(200, models.NewSingleResponse[${DOMAIN_NAME_UPPER}](entity, ""))
}
...
func (h *${DOMAIN_NAME_LOWER}Handler) Create(c *gin.Context) {
	...
	c.JSON(201, models.NewSingleResponse[${DOMAIN_NAME_UPPER}](created, "Created successfully"))
}
...
func (h *${DOMAIN_NAME_LOWER}Handler) Update(c *gin.Context) {
	...
	c.JSON(200, models.NewSingleResponse[${DOMAIN_NAME_UPPER}](updated, "Updated successfully"))
}
...
func (h *${DOMAIN_NAME_LOWER}Handler) Delete(c *gin.Context) {
	...
	c.JSON(200, models.NewSingleResponse[${DOMAIN_NAME_UPPER}](nil, "Deleted successfully"))
}
EOF
