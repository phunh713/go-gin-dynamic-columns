...
func (h *invoiceHandler) GetAll(c *gin.Context) {
	...
	c.JSON(200, models.NewListResponse(invoices, nil, ""))
}
...
func (h *invoiceHandler) GetById(c *gin.Context) {
	...
	if err != nil {
		c.JSON(500, models.NewErrorResponse("Failed to get invoice", err.Error()))
		return
	}
	c.JSON(200, models.NewSingleResponse(invoice, ""))
}
...
func (h *invoiceHandler) Create(c *gin.Context) {
	...
	if err != nil {
		c.JSON(500, models.NewErrorResponse("Failed to create invoice", err.Error()))
		return
	}
	c.JSON(200, models.NewSingleResponse(invoice, "Invoice created successfully"))
}
...
func (h *invoiceHandler) Update(c *gin.Context) {
	...
	if err != nil {
		c.JSON(500, models.NewErrorResponse("Failed to update invoice", err.Error()))
		return
	}
	c.JSON(200, models.NewSingleResponse(invoice, "Invoice updated successfully"))
}
...
func (h *invoiceHandler) Delete(c *gin.Context) {
	...
	if err != nil {
		c.JSON(500, models.NewErrorResponse("Failed to delete invoice", err.Error()))
		return
	}
	c.JSON(200, models.NewSingleResponse[Invoice](nil, "Invoice deleted successfully"))
}
